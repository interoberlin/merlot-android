...
public enum ECharacteristic {
    ...
    INTEROBERLIN_UART_TX(EService.INTEROBERLIN_UART, "00002002-0000-1000-8000-00805f9b34fb"),
    INTEROBERLIN_UART_RX(EService.INTEROBERLIN_UART, "00002003-0000-1000-8000-00805f9b34fb"),

    SENTIENT_LIGHT_FLOOR_SENSOR_TX(EService.SENTIENT_LIGHT_FLOOR_SENSOR, "00003002-0000-1000-8000-00805f9b34fb"),
    SENTIENT_LIGHT_FLOOR_SENSOR_RX(EService.SENTIENT_LIGHT_FLOOR_SENSOR, "00003003-0000-1000-8000-00805f9b34fb"),
    SENTIENT_LIGHT_LED_TX(EService.SENTIENT_LIGHT_LED, "00004002-0000-1000-8000-00805f9b34fb"),
    SENTIENT_LIGHT_LED_RX(EService.SENTIENT_LIGHT_LED, "00004003-0000-1000-8000-00805f9b34fb");
    ...
    public EFormat getFormat(Context context) {
        if (RepositoryMapper.getInstance(context).isKnownCharacteristic(id)) {
            return RepositoryMapper.getInstance(context).getCharacteristicById(id).getFormat();
        }
